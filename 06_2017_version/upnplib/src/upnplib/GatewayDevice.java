...
public class GatewayDevice {
    ...
    public void loadDescription() throws SAXException, IOException {
        ...
        /*write the device description into deviceDescription.txt
        InputStream in=urlConn.getInputStream();
        FileOutputStream fo=new FileOutputStream(new File("deviceDescrition.txt"));
    ...
    public boolean addPortMapping(int externalPort, int internalPort,
        ...
        Set<Map.Entry<String, String>> result=nameValue.entrySet();
        Iterator<Map.Entry<String,String>> ii=result.iterator();
        while(ii.hasNext())
        {
        		Map.Entry<String, String> item=ii.next();
        		System.out.println("port adding response: "+item.getKey()+" "+item.getValue());
        }
