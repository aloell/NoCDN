...
public class GatewayDiscover {
    ...
    private GatewayDevice parseMSearchReply(byte[] reply) {
        ...
        System.out.println("below is the reponse of first time broadcasting!");
        ...
        System.out.println("here is the end of response of broadcasting!");
        return device;
    }
    ...
    private List<InetAddress> getLocalInetAddresses(boolean getIPv4, boolean getIPv6, boolean sortIPv4BeforeIPv6) {
        ...
        while (networkInterfaces.hasMoreElements()) {
            ...
            while (addresses.hasMoreElements()) {
                ...
                System.out.printf("get ip address in a interface: %s, "
                		+ "interface name1:%s,getNAME2:%s\n",
                		inetAddress,card.getDisplayName(),card.getName());
