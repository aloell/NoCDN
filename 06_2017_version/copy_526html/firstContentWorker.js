onmessage=function(e)
{
    ...
    xhttp.onreadystatechange=function()
    {
    	if (xhttp.readyState === XMLHttpRequest.DONE&&xhttp.status == 200) {
        	...
        	var scriptTagMatchResult=text.match(scriptTagPattern);
        	counter=imgMatchResult.length+linkTagMatchResult.length+scriptTagMatchResult.length;
			var extendedFrame1;
			var extendedFrame2;
			var extendedFrame3;
        	var relativeDeepUrl;
        	...
        	{
          		relativeDeepUrl=imgMatchResult[i].substring(13,imgMatchResult[i].length-1);
          		absoluteDeepUrl=peerUrl+relativeDeepUrl;
          		nextLevelPara[0]=absoluteUrl;
